...
-  creating Todo java file taking values of to do
- creating Todo service for add/retrive/delete 
- creating todo controller and for autowire Todoservice
- creating list-todos jsp file for showing todo list.
...
<body>
welcome <a href="/list-todos">click here</a>
</form>
</body>
</html>
```
